...
//	Constants for known variables
	...
	public static void main(String[] args) {
		...
		NetworkTable.setIPAddress("roborio-1710-frc.local");
...
//				opens up the camera stream and tries to load it
				...
				videoCapture.open("http://roborio-1710-frc.local:1181/?action=stream");
...
//		only run for the specified time
	...
	public static void DoTheThing() {
		angleToTarget = returnCenterX();
		SmartDashboard.putNumber("Angle To Target", angleToTarget);
		Drive.rotateToAngle((float) angleToTarget);
	}
}